...
public class AppService extends Service{
    public AppService() {
       ...
       setMenuChoices(
        new Runnable[]{
            this::addCompany,
            this::addEquipment,
            this::addEquipmentInterface,
            this::addConnection,
            this::addPacket,
            this::listEquipmentInterfaces,
            this::updatePacketLayer2Header,
            this::listPacketsDataForEquipment,
            this::updateInterfaceIpAndMask,
            this::removeConnection,
            this::addMacAddressEntry,
            this::addRoute,
            this::listMacAdressTableForEquipment,
            this::removeRoute,
            () -> {
    ...
    public void addEquipmentInterface(){
    ...
    protected void listEquipmentInterfaces(){
    ...
    protected void updatePacketLayer2Header(){
    ...
    protected void listPacketsDataForEquipment(){
        System.out.println("Equipment id: ");
        Integer equipment_id = scanner.nextInt();
    ...
    protected void updateInterfaceIpAndMask(){
    ...
    protected void addMacAddressEntry(){
    ...
    protected void listMacAdressTableForEquipment(){
        System.out.println("Equipment id: ");
        Integer equipment_id = scanner.nextInt();
        scanner.nextLine();
    ...
    protected boolean isValidMacAddr(String mac_addr){
    ...
    protected int parseIp(String ip) throws RuntimeException, NumberFormatException {
        Integer result = 0;
